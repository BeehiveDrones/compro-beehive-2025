    ...
    <div className="bg-white border  border-gray-200 rounded-lg shadow-md p-6 flex flex-col justify-between">
      ...
      <div className="text-right">
        <button
          ...
          className="inline-flex items-center bg- text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200"
        >
          Read More
  ...
  const jobPostings: Job[] = [
    {
      ...
      requirements: [
        'Currently enrolled in or recently graduated from a relevant design program.',
        'Proficiency in design tools (e.g., Figma, Sketch, Adobe XD).',
        'Basic understanding of user-centered design principles.',
        'Strong communication and collaboration skills.',
        'A portfolio showcasing design projects (school projects are welcome).',
      ],
      responsibilities: [
        'Assist in conducting user research and analyzing user feedback.',
      ...
      applyLink: 'mailto:careers@beehivedrones.com?subject=Application for Internship UI/UX Designer'
    },
    {
      id: 'front-end-dev-1',
