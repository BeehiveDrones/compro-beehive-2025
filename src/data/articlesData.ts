...
export const articles: Article[] = [
  {
    ...
    title: 'Beehive Drones Unveils Indonesia’s First Emission-Detecting Marine Drone',
    dateUpload: '03 Juni 2024',
    images: ['/article/1.png'],
    content: [
        'In collaboration with Institut Teknologi Sepuluh Nopember (ITS) and the Indonesian Classification Bureau (BKI), Beehive Drones has developed Indonesia’s first marine-sniffing drone—an innovative unmanned aerial vehicle (UAV) designed to detect shipborne air emissions. Officially launched on Tuesday (28/5), the drone is equipped with real-time data capabilities and a suite of advanced features that enhance its accuracy and operational functionality, marking a major step forward in environmental monitoring technology in Indonesia.',

'The BVD-M16A sniffing drone is a versatile UAV built primarily to detect airborne greenhouse gas emissions. Equipped with sophisticated sensors, it can identify and measure concentrations of seven key pollutants—CO₂, CO, NO₂, NO, SO₂, PM2.5, and PM10—in real-time via the putaradar.id platform. This functionality supports regulatory bodies such as BKI and the Port Authority (KSOP) in enforcing ship standardization and monitoring port operations, contributing to broader national efforts to reduce air pollution.',
...
'After undergoing comprehensive tests for sniffing, surveillance, and water operations, the BVD-M16A proved capable of meeting all expectations—demonstrating its readiness for commercialization and real-world deployment.',
...
'Nanang Afandi, Head of Sea Transport and Port Traffic at the Directorate General of Sea Transportation, expressed optimism about the tool’s potential. He noted that the drone could significantly support KSOP in monitoring ship emissions at Tanjung Perak Port and hoped it would see broader use across the country to help achieve Indonesia’s net-zero emissions target by 2060. He emphasized that adopting this kind of technology is a vital step toward reducing pollution and preserving the environment.',
    ],
  ...
  },
  {
    ...
    content: [
      'The Indonesian Student Association in Japan (PPI Japan) successfully held a webinar titled “Innovation and Future Perspectives in Agriculture and Food Technologies”, featuring three prominent speakers from various institutions. The event aimed to explore the latest innovations in agriculture and highlight opportunities for collaboration among academia, industry, and research institutions to advance agricultural technology in Indonesia.',

'The webinar was attended by the Agricultural Attaché of the Indonesian Embassy in Tokyo, Andi Hidayat, who emphasized the critical role of technology in addressing challenges within the agricultural sector. He also linked the discussion to national priorities such as the government’s free nutritious meal program and commended PPI Japan’s initiative in bringing experts together to foster strategic collaboration.',
...
'Prima Gandhi, Chairperson of PPI Japan, emphasized that agriculture remains one of Indonesia’s comparative advantages, particularly compared to four-season countries. He highlighted the importance of eco-friendly technologies, customized mechanization for small-scale farms, and the development of agritech startups to improve market efficiency and farmer welfare.',
...
'The K3 training completed by the Beehive Drones team is proof of our commitment to maintaining safety standards and service quality. With a focus on professionalism and innovation, Beehive Drones is ready to continue growing and leading the drone industry in Indonesia. We believe that investing in workplace safety will have a positive impact on operational outcomes and customer satisfaction. With a drive to keep advancing, Beehive Drones will continue to deliver more advanced, efficient, and safe UAV technology for various industries. 🚀',
'#BeehiveDrones #Drone #UAV #IndonesiaDrone #DroneTechnology #AerialSurvey #DroneMapping #K3Safety #OccupationalSafety #Innovation #AerospaceTechnology #RedefiningthePossibilities',
...

  {
    ...
    content: [
        ...
        'Stay tuned for more updates as we embark on this exciting journey of collaboration and innovation! ✨',
...

  {
    ...
    title: 'Unlocking Loa Lepu’s Potential through Aerial Mapping and Remote Sensing Analytics',
    dateUpload: '08 April 2025',
    images: ['/article/5.png'],
    content: [
      'Loa Lepu, a peaceful village located between Tenggarong and Samarinda in East Kalimantan, is stepping into a new era of data-driven development. Surrounded by the Mahakam River and lush landscapes, Loa Lepu is rich in agriculture, fisheries, and local wisdom—waiting to be transformed through the power of technology.',

'In a strategic collaboration, Lumbung Muncul Sejahtera and Beehive Drones are leveraging cutting-edge aerial mapping and remote sensing analysis to unlock the village’s full potential. Through high-resolution geospatial data and impact-based assessment, this initiative identifies key opportunities to enhance land productivity, streamline resource use, and boost eco-tourism while preserving the environment.',

'Lumbung Muncul Sejahtera, a leader in data analytics and sustainable resource management, provides a deep understanding of regional development aligned with environmental goals. Supporting this vision, Beehive Drones—a leading Indonesian drone system provider—focuses on R&D-based UAV solutions for conventional industries. Their services include surveillance drones, drone mapping, and aerial surveys designed to deliver actionable insights from the sky.',
...
'This initiative demonstrates how technology, when grounded in local context, can drive inclusive and intelligent rural transformation—making Loa Lepu a model for future-ready villages in Indonesia.',
...
'<b>#BeehiveDrones #DroneMapping #RemoteSensing #DroneSurvey #IndonesiaDrone #SmartVillage #AerialSurvey #UnmannedAerialVehicle #SustainableFuture #TechForImpact #VillageInnovation</b>',
  ...
  },
  {
    ...
    content: [
      'In the face of natural disasters—such as earthquakes, floods, landslides, and volcanic eruptions—rapid situational awareness and accurate mapping are critical for saving lives and minimizing damage. However, complex terrains, collapsed structures, and limited visibility often challenge conventional response methods. That’s where cutting-edge technologies like Visual Simultaneous Localization and Mapping (vSLAM) come into play.',
...
'Here’s how our vSLAM-powered solutions contribute across the disaster lifecycle:',
'1) Pre-Disaster',
...
'More than just a partnership, this MoU represents a shared commitment to building a future-ready tourism ecosystem powered by innovation, data, and cutting-edge aerial technology. “This collaboration is a stepping stone towards redefining tourism experiences,” said the CEO of Beehive Drones. “Technology should not only support the industry—it should elevate it, creating immersive, efficient, and informed travel experiences.”',
...
'With a shared vision of integrating drone technology in Indonesia’s tourism landscape, Beehive Drones and JTTC aim to become pioneers in building a smarter, more connected, and globally competitive tourism sector.',
...
'<b>#SmartTourism #DroneInnovation #BeehiveDrones #JTTC #IndonesiaDrone #UnmannedAerialVehicle #TechMeetsTravel</b>',
  ...
  },
  {
    ...
    content: [
      'The CEO of Beehive Drones and Lumbung Muncul Sejahtera, Albertus Gian, participated in InnoEX 2025, held from April 13–16, 2025, at the Hong Kong Convention and Exhibition Centre. This event gathered industry leaders, tech entrepreneurs, and investors from around the globe to exchange insights and explore international collaboration opportunities in cutting-edge technology sectors.',
...
'For Beehive Drones and Lumbung Muncul Sejahtera, InnoEX 2025 proved to be a valuable opportunity to gain crucial insights into emerging technologies and potential global partnerships. By networking and deepening knowledge of global technological developments, we aim to drive continuous innovation in drone technology and data analysis, while strengthening Indonesia’s position in the global tech landscape.',

'In a world where technological advancements are reshaping industries, attending such a prestigious event has equipped us with the knowledge and connections necessary to further elevate companies’ capabilities and ensure that our innovations are at the forefront of the global stage.',
...
'<b>#InnoEX2025 #BeehiveDrones #IndonesiaDrone #UnmannedAerialVehicle #DroneTechnology #AerialSurvey #RemoteSensingAnalysis #TechInnovation #GlobalTechNetworking #LumbungMunculSejahtera</b>',],
  ...
  },
  {
    ...
    content: [
      'Yogyakarta, April 28, 2025 — In a forward-thinking initiative to enrich their students’ learning experiences, representatives from Evergreen Secondary School, one of Singapore’s leading educational institutions, recently visited Beehive Drones in Yogyakarta. This visit was a key part of their preparation for an immersive, hands-on exposure to drone technology, as part of an exciting new educational program aimed at introducing students to cutting-edge industries.',

'The delegation explored the facilities and engaged with Beehive’s innovative solutions in the drone technology sector, assessing the company’s capabilities in providing real-world learning experiences. Beehive Drones is recognized as one of Indonesia\'s leaders in developing advanced drone systems for industries such as agriculture, environmental monitoring, and infrastructure.',
...
'<b>#InternationalCollaboration #DroneInnovation #STEMinspiration #TechForGood #PrecisionMapping #DroneTechnology #HandsOnLearning #STEMEducation #GlobalCollaboration #DroneEducation #InnovativeLearning #InnovationInEducation #BeehiveDrones #RedefiningthePossibilities</b>',
  ...
  },
  {
    ...
    content: [
      'UNAIR NEWS - In order to improve students\' data analysis skills, the Faculty of Fisheries and Marine Sciences (FPK) Universitas Airlangga (UNAIR) held a guest lecture entitled R Application in Oceanographic Analysis on Monday, April 28, 2025. The activity was attended by dozens of 6th semester students of the Fisheries Product Technology Study Program and was held online via Zoom Meeting.',
...
'✅ Real-world Use Cases of Drone Technology in Oil Palm Plantations',
'✅ Drone Operation Techniques & Piloting Best Practices',
'✅ Hands-on Drone Assembly and Live Flight Demonstration',

'This training reflects Beehive Drones and Lumbung Muncul Sejahtera’s shared mission: to build capacity and empower the next generation of agricultural innovators by making advanced technology accessible and practical—especially for smallholder plantations.',
...
'Through internship programs, students will gain valuable insight into how drones (UAVs) are applied across various sectors—ranging from data acquisition, surveillance, and mapping to drone manufacturing, data analytics, and research & development. The collaboration aligns with Beehive Drones\' mission to build a connected ecosystem that accelerates drone innovation and supports talent development.',

'This MoU signifies the beginning of a promising journey between academia and industry—one that empowers students, strengthens research potential, and contributes to the advancement of drone technology in Indonesia.',
...
'<b>#DroneIndonesia #DroneTKDN #DroneStandardISO #BeehiveDrones #DroneServices</b>',
  ...
  },
  {
    ...
    content: [
        ...
        'This industrial visit introduced students to cutting-edge drone technology, local manufacturing innovation, and the entrepreneurial journey of Beehive Drones — an ISO 9001:2015 certified drone company with a strong focus on research and development, as well as the practical application of its innovations in conventional industries.',
        ...
        'The visit concluded with live demonstrations of VTOL drone flights and FPV drone operations, with the FPV view displayed on screens to give students a drone’s point of view (POV).',
        ...
        '“Using VR to control the drone was fascinating.”',
        '“The CEO’s journey inspired me to be courageous and persistent.”',
        '“I loved seeing innovation in action.”',
        ...
        'If you’re an educational institution or international partner interested in hosting similar STEM learning experiences, contact us to explore collaboration opportunities. Learn more about Beehive Drones: linktr.ee/beehive_drones',
  ...
  },
  {
    ...
    content: [
        'What if Indonesia could power its industries with more local components—cutting reliance on imports, boosting jobs, and strengthening its economy? That’s the dream behind TKDN, or the Domestic Component Level policy.',

        'TKDN is Indonesia’s way of saying: “Let’s build with what we have.” The regulation pushes industries to use more locally sourced materials in their production process. It’s a national strategy to grow homegrown capabilities, boost competitiveness, and promote economic independence.',
        'But for many companies, the path isn’t easy.',
        
        '“It’s not that we don’t want to use local materials,” says Manda, founder of Beehive Drones, a Yogyakarta-based drone tech startup. “It’s that they’re just not up to the mark—yet.”',
        
        'In the high-precision world of drones, quality is everything. Sensors, processors, and lightweight composite materials often need to meet international standards—and many simply aren\'t available locally. As a result, companies like Beehive Drones are caught in a balancing act between supporting national policy and staying globally competitive.',
        ...
        'The challenges don’t stop at raw materials. Indonesia also faces a talent gap. High-tech manufacturing demands engineers skilled in AI, navigation systems, and precision hardware—talents that are still rare across the local workforce. To meet TKDN, companies often need to invest heavily in training and tech transfer, increasing both time and costs.',
        ...
        'In short? TKDN isn’t just a regulation—it’s a movement.',
        ...
        'If done right, TKDN could unlock a powerful future for Indonesia—where local industries thrive, global standards are met, and the country takes a stronger seat in the world economy.',
        
        'The big question isn’t whether TKDN is a burden or an opportunity.',
        'It’s whether we’re ready to invest in making it work.',
  ...
  },
  {
    ...
    content: [
        'From July 3–5, 2025, the ASEAN-India Scale Hub was held at Discovery Kartika Plaza Hotel in Bali, bringing together startups and innovators from across Southeast Asia and India. The event served as a platform for exchanging ideas, forming strategic partnerships, and amplifying the impact of innovation across the region.',
        'Beehive Drones and Lumbung Muncul Sejahtera, two companies under the Aero Versum Group, proudly participated in this international initiative — highlighting their integrated approach to drone technology and data analytics for data-driven decision-making.',
        
        'During the event, Beehive Drones was honored with the Channel Excellence Award in Defense & Aerospace. This recognition underscores the company’s significant contributions to advancing drone applications in the region and reaffirms its mission to transform cutting-edge drone technology into practical, results-oriented solutions.',
        
        '🛰️ About Beehive Drones & Lumbung Muncul Sejahtera',
        '1) Beehive Drones (PT. Aerotek Global Inovasi) is an ISO 9001:2015-certified provider of drone technology, specializing in research, development, and implementation. The company’s mission is to redefine drone technology to provide solutions across various industries.',
  ...
  },
  {
    ...
    content: [
      'Beehive Drones and Lumbung Muncul Sejahtera, under the umbrella of Aero Versum Group, proudly joined forces with Badan Perakitan dan Modernisasi Pertanian (BRMP) Central Java at the Pekan Agro Digital & Inovasi (PADI) Jateng 2025, held at Agro Center Soropadan, July 18–22, 2025. This annual event brought together a dynamic mix of stakeholders—farmers, agri-tech innovators, educators, policymakers, and private sector leaders—to explore the future of smart and digital agriculture in Indonesia.',
      ...
      'The participation of Aero Versum Group at PADI Jateng 2025 underscores its commitment to transforming agriculture through innovation. By combining drone technology, data analytics, and agricultural digital platforms, the group aims to make precision farming more accessible, inclusive, and impactful—supporting the national agenda for sustainable agricultural development.',
    ],
    author: 'Admin Marketing',
  },
  {
    id: 19,
    category: ['Company News'],
    title: 'Celebrating Indonesia’s 80th Independence Day',
    dateUpload: '18 August 2025',
    images: ['/article/19.png'],
    content: [
      'This year’s 80th Independence Day was not only a moment to commemorate Indonesia’s long journey of freedom, but also an opportunity for us at, <b>Beehive Drones</b> and <b>Lumbung Muncul Sejahtera</b> to celebrate togetherness and unity within our teams. 🇮🇩✨',
'The celebration began with morning exercise to recharge our energy, followed by fun team games that strengthened collaboration and camaraderie among colleagues. To close the day, we shared a potluck lunch where everyone contributed, reflecting the spirit of gotong royong that lies at the heart of Indonesia’s identity.',
'For us, this Independence Day is more than a national commemoration—it is a reminder of the values we uphold as organizations: <b>collaboration, resilience, and collective growth.</b> Just as Indonesia continues to progress, we believe that our teams can achieve greater impact by moving forward together.',
...
'<b>✨ Beehive Drones & Lumbung Muncul Sejahtera</b>',
 'Redefining the possibilities to cultivate the sustainable future.',
  ...
  },
  {
    ...
    content: [
      '<b>Yogyakarta, August 14, 2025 </b> – Beehive Drones proudly announced the successful manufacturing and handover of its latest innovation, the <b>BVD-M14 mapping drone</b>, to <b>CV Glory Albeta.</b> This milestone reflects Beehive Drones’ commitment to delivering cutting-edge drone solutions built under the <b>ISO 9001:2015 quality management standard.</b>',
...
'“The handover of BVD-M14 to CV Glory Albeta marks not only a product delivery, but also a partnership in advancing data-driven solutions through drone technology,” said a Beehive Drones representative. “We remain committed to supporting industries with innovative tools that enhance efficiency, accuracy, and sustainability.”',
'As part of Beehive Drones’ vision, the launch of the BVD-M14 reinforces the company’s dedication to developing <b> research-based, locally manufactured drone technologies</b> that can compete globally while addressing real-world challenges.',
